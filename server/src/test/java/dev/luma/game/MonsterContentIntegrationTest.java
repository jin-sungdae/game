...
class MonsterContentIntegrationTest {
    ...
    @Test void evenExplicitlyEnabledAlphaAndUnknownDbRowsCannotEnterEncounterCandidates() {
        ...
        assertEquals(List.of("PIP","MELLO","MOSSY","CHIRP","BUBU","PEBB","PUFF","TIKKI","MIMI","WISP","SHADE","EMBER","LUNET","NOVA","NOCT"),repository.monsters().stream().map(MonsterSelector.Monster::code).toList());

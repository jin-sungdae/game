...
./node_modules/.bin/tsc src/presentation/model.ts src/presentation/baseMotion.ts src/presentation/evolution.ts --outDir "$LUMA_PRESENTATION_TEST_DIR" --module commonjs --target ES2022 --strict --skipLibCheck
